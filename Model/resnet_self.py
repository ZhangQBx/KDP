...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        print('used total class:{}'.format(num_classes))
        self.inplanes = 64
        self.dilation = 1
...
def _resnet(arch, block, layers, pretrained, progress, num_class, **kwargs):
    model = ResNet(block, layers, num_classes=num_class, **kwargs)
    if pretrained:
...
def resnet18_self(pretrained=False, progress=True, num_class=10, **kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, num_class,
                   **kwargs)


def resnet34_self(pretrained=False, progress=True, **kwargs):
...
def resnet50_self(pretrained=False, progress=True, num_class=10, **kwargs):
...
def resnet101_self(pretrained=False, progress=True, **kwargs):
...
def resnet152_self(pretrained=False, progress=True, **kwargs):
...
def resnext50_32x4d_self(pretrained=False, progress=True, **kwargs):
...
def resnext101_32x8d_self(pretrained=False, progress=True, **kwargs):
...
def wide_resnet50_2_self(pretrained=False, progress=True, **kwargs):
...
def wide_resnet101_2_self(pretrained=False, progress=True, **kwargs):
